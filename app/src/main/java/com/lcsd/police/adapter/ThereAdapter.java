 ...
 */
public class ThereAdapter extends BaseAdapter{
    private Context mContext;
    private List<SecondLevel.TSublist> list;

    public ThereAdapter(Context mContext, List<SecondLevel.TSublist> list) {
